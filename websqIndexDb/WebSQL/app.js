	...
	var imageName= "";
       ...
       tx.executeSql('insert into deptTable(did, dName, estd) values(1,"CSE","' + today + '")');  
       tx.executeSql('insert into deptTable(did, dName, estd) values(2,"BBA","' + today + '")');  
       tx.executeSql('insert into deptTable(did, dName, estd) values(3,"LLB","' + today + '")');  
       tx.executeSql('insert into deptTable(did, dName, estd) values(4,"English","' + today + '")');
        ...
        function alldetails(){  
            dbObj.transaction(function (tx) {  
                ...
                $('#blah').attr('src', results.rows.item.image);
